...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ssh::deploy_key_to_node,
            ...
            commands::yubikey::check_fido2_dependencies,
            commands::yubikey::install_fido2_dependencies,
            commands::yubikey_setup::check_remote_ssh_version,
            commands::yubikey_setup::harden_remote_sshd,
